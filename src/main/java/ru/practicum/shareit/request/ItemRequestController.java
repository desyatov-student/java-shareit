...
import ru.practicum.shareit.request.dto.NewItemRequestBody;
...
public class ItemRequestController {
    ...
    public ItemRequestDto create(
            @RequestHeader(HEADER_X_SHARER_USER_ID) Long userId,
            @Valid @RequestBody NewItemRequestBody request
    ) {
        return itemRequestService.create(NewIteRequestRequest.of(userId, request.getDescription()));
    }
}
